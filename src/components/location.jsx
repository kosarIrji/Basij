    ...
    >
      ...
      {windowHeight < 500 ? (
        ...
        >
          ...
          محله بسیج (میرزا رضا کرمانی) در بخش مرکزی و نیمه غربی شهر بجنورد و محدوده منطقه دو شهری قرار دارد . و در مجاورت محله‌های ارتش، مصلی، دوچنار و فردوسی واقع شده و از طریق خیابان‌های اصلی طالقانی و امام خمینی به سایر نقاط شهر متصل است.
          </p>
        </motion.div>
      ) : (
        ""
