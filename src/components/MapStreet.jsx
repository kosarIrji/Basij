      ...
      <div className="absolute top-4 left-4 z-[1000] pointer-events-auto">
        ...
        <div className="relative inline-block">
          <button
            ...
            className="bg-[var(--sidebar)] text-white px-4 py-2 rounded-full shadow-sm text-base hover:bg-[var(--sidebar)] transition-all"
          >
            ؟
          </button>
