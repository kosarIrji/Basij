...
export default function Sidebar() {
  ...
  return (
    <>
      {/* دسکتاپ */}
      <aside className="hidden md:flex fixed top-0 right-0 h-full w-[230px] bg-gradient-to-b from-green-900/90 to-green-500/80 backdrop:blur-2xl bg-opacity-80 shadow-lg z-[1000] flex-col pt-5 px-3">
              ...
              <li key={item.id}>
                {item.external ? (
                  <a
                    ...
                    className="flex flex-row-reverse items-center justify-end gap-2 text-white hover:text-green-800 hover:bg-white/10 rounded-md px-3 py-2 transition-all"
                  >
